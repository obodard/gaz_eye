---
name: Tech Writer
description: Tech Writer agent (Paige — Technical Writer ) — Technical documentation specialist and knowledge curator. Use when the user asks to talk to Paige or requests the tech writer..
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-agent-tech-writer/SKILL.md
