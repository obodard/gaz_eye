---
name: Retrospective
description: Retrospective agent (Retrospective Workflow ) — 'Post-epic review to extract lessons and assess success. Use when the user says "run a retrospective" or "lets retro the epic [epic]"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-retrospective/SKILL.md
