---
name: Correct Course
description: Correct Course agent (Correct Course - Sprint Change Management Workflow ) — 'Manage significant changes during sprint execution. Use when the user says "correct course" or "propose sprint change"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-correct-course/SKILL.md
