---
name: Product Brief
description: Product Brief agent (Create Product Brief ) — Create or update product briefs through guided or autonomous discovery. Use when the user requests to create or update a Product Brief..
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-product-brief/SKILL.md
