---
name: Dev Story
description: Dev Story agent (Dev Story Workflow ) — 'Execute story implementation following a context filled story spec file. Use when the user says "dev this story [story file]" or "implement the next story in the sprint plan"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-dev-story/SKILL.md
