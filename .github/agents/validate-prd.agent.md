---
name: Validate Prd
description: Validate Prd agent (PRD Validate Workflow ) — 'Validate a PRD against standards. Use when the user says "validate this PRD" or "run PRD validation"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-validate-prd/SKILL.md
