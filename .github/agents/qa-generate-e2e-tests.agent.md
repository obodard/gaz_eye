...
description: Qa Generate E2e Tests agent (QA Generate E2E Tests Workflow ) — 'Generate end to end automated tests for existing features. Use when the user says "create qa automated tests for [feature]"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-qa-generate-e2e-tests/SKILL.md
