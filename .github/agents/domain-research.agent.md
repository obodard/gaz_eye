...
description: Domain Research agent (Domain Research Workflow ) — 'Conduct domain and industry research. Use when the user says wants to do domain research for a topic or industry'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-domain-research/SKILL.md
