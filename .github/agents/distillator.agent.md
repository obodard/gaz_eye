---
name: Distillator
description: Distillator agent (Distillator: A Document Distillation Engine ) — Lossless LLM-optimized compression of source documents. Use when the user requests to 'distill documents' or 'create a distillate'..
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-distillator/SKILL.md
