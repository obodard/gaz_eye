---
name: Pm
description: Pm agent (John — Product Manager ) — Product manager for PRD creation and requirements discovery. Use when the user asks to talk to John or requests the product manager..
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-agent-pm/SKILL.md
