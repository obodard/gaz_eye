...
description: Generate Project Context agent (Generate Project Context Workflow ) — 'Create project-context.md with AI rules. Use when the user says "generate project context" or "create project context"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-generate-project-context/SKILL.md
