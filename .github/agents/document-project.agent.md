...
description: Document Project agent (Document Project Workflow ) — 'Document brownfield projects for AI context. Use when the user says "document this project" or "generate project docs"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-document-project/SKILL.md
