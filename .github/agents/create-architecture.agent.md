...
description: Create Architecture agent (Architecture Workflow ) — 'Create architecture solution design decisions for AI agent consistency. Use when the user says "lets create architecture" or "create technical architecture" or "create a solution design"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-create-architecture/SKILL.md
