---
name: Ux Designer
description: Ux Designer agent (Sally — UX Designer ) — UX designer and UI specialist. Use when the user asks to talk to Sally or requests the UX designer..
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-agent-ux-designer/SKILL.md
