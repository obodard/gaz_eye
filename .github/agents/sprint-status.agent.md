---
name: Sprint Status
description: Sprint Status agent (Sprint Status Workflow ) — 'Summarize sprint status and surface risks. Use when the user says "check sprint status" or "show sprint status"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-sprint-status/SKILL.md
