...
description: Checkpoint Preview agent (Checkpoint Review Workflow ) — 'LLM-assisted human-in-the-loop review. Make sense of a change, focus attention where it matters, test. Use when the user says "checkpoint", "human review", or "walk me through this change".'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-checkpoint-preview/SKILL.md
