...
description: Market Research agent (Market Research Workflow ) — 'Conduct market research on competition and customers. Use when the user says they need market research'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-market-research/SKILL.md
