---
name: Create Prd
description: Create Prd agent (PRD Create Workflow ) — 'Create a PRD from scratch. Use when the user says "lets create a product requirements document" or "I want to create a new PRD"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-create-prd/SKILL.md
