...
description: Technical Research agent (Technical Research Workflow ) — 'Conduct technical research on technologies and architecture. Use when the user says they would like to do or produce a technical research report'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-technical-research/SKILL.md
