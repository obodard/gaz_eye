---
name: Edit Prd
description: Edit Prd agent (PRD Edit Workflow ) — 'Edit an existing PRD. Use when the user says "edit this PRD".'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-edit-prd/SKILL.md
