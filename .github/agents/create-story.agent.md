---
name: Create Story
description: Create Story agent (Create Story Workflow ) — 'Creates a dedicated story file with all the context the agent will need to implement it later. Use when the user says "create the next story" or "create story [story identifier]"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-create-story/SKILL.md
