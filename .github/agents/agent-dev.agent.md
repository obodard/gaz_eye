---
name: Dev
description: Dev agent (Amelia — Senior Software Engineer ) — Senior software engineer for story execution and code implementation. Use when the user asks to talk to Amelia or requests the developer agent..
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-agent-dev/SKILL.md
