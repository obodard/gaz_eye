---
name: Code Review
description: Code Review agent (Code Review Workflow ) — 'Review code changes adversarially using parallel review layers (Blind Hunter, Edge Case Hunter, Acceptance Auditor) with structured triage into actionable categories. Use when the user says "run code review" or "review this code"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-code-review/SKILL.md
