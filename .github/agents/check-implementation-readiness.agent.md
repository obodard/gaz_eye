...
description: Check Implementation Readiness agent (Implementation Readiness ) — 'Validate PRD, UX, Architecture and Epics specs are complete. Use when the user says "check implementation readiness".'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-check-implementation-readiness/SKILL.md
