...
description: Create Epics And Stories agent (Create Epics and Stories ) — 'Break requirements into epics and user stories. Use when the user says "create the epics and stories list"'.
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-create-epics-and-stories/SKILL.md
