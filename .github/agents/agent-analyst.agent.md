---
name: Analyst
description: Analyst agent (Mary — Business Analyst ) — Strategic business analyst and requirements expert. Use when the user asks to talk to Mary or requests the business analyst..
...
1. LOAD the FULL agent file from {project-root}/.agents/skills/bmad-agent-analyst/SKILL.md
